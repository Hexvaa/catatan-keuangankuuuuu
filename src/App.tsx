...
function LiveClock({ textColor="inherit", mutedColor="rgba(128,128,128,0.7)" }: { textColor?:string; mutedColor?:string }) {
  const [t, setT] = useState(new Date())
  useEffect(() => { const id = setInterval(() => setT(new Date()), 1000); return () => clearInterval(id) }, [])
  return (
    <div style={{ display:"flex", alignItems:"center", gap:6 }}>
      <span style={{ fontSize:18, fontWeight:700, fontFamily:"DM Mono, monospace", letterSpacing:"0.04em", color:textColor }}>
  ...
  return (
    <div style={{ minHeight:"100vh", background:P.bg, paddingBottom:100 }}>
      ...
      <div style={{ maxWidth:520, margin:"0 auto", padding:"48px 20px 80px", position:"relative" }}>
        ...
        {/* Live clock */}
        <div className="au" style={{ display:"flex", justifyContent:"center", marginBottom:12 }}>
          <LiveClock textColor={P.text} mutedColor={P.muted}/>
        </div>
