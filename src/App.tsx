            ...
            <div style={{ display:"flex", alignItems:"flex-end", gap:12 }}>
              ...
              <div>
                ...
                <div style={{ display:"flex", alignItems:"center", gap:6, marginTop:8 }}>
                  <span style={{ fontSize:10, color:P.muted, fontFamily:"Instrument Sans, sans-serif", fontWeight:600, letterSpacing:"0.06em", textTransform:"uppercase" }}>🕐</span>
                  <span style={{ fontSize:16, fontWeight:700, color:P.text, fontFamily:"DM Mono, monospace", letterSpacing:"0.04em" }}>
                    {clockNow.toLocaleTimeString("id-ID", { hour:"2-digit", minute:"2-digit", second:"2-digit", timeZone:"Asia/Jakarta" })}
                  </span>
                  <span style={{ fontSize:11, color:P.muted, fontFamily:"Instrument Sans, sans-serif", fontWeight:600 }}>WIB</span>
                </div>
              </div>
            </div>
          </div>
